        ...
        <div class="main">
            <div class="header">
                ...
                <ul style="font-size:30px; float:right;">
                    <a href="index.php" style="text-decoration: none;"><li style="list-style: none; text-decoration: none; list-style-type: none; color:orange;">HOME</li></a>
            ...
            <div class="definition">
                <div class="container" id="mainbody">
                    <p>WELCOME TO THE DSV BANKING SERVICES</p>
                    <a href="customers.php"><button value="customers" name="customers">CUSTOMERS</button></a>
                    <br><br>
                    <a href="transactions.php"><button value="transactions" name="transactions">TRANSACTIONS</button><br><br></a>
